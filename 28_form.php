  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="/cwgphp/21_Get_Post.php">Home <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
...
<strong>Error!</strong> We are facing some technical issues and Your entry was not submitted successfully| We regret the iconvinience caused!
<button type="button" class="close" data-dismiss="alert" aria-label="Close">
  <span aria-hidden="true">&times;</span>
</button>
</div>';
...
<form action = "/cwgphp/28_form.php" method="post">
